...
let skillsList = ["HTML5", "CSS3", "SASS/SCSS", "Responsive and adaptive layout", "JavaScript, ES5/ES6, DOM", "AJAX, Fetch API", "Git, Github", "NPM", "React js, JSX", "Redux, GraphQl", "Webpack", "Babel"];
                ...
                <div className="about">
                    <div className="about-container">
                        <div className="about-me"><div className="photo"></div><p>{description.split(' ').map((word, index) => {
                            return <span className="animated rollIn" style={{ animationDelay: index * 60 + 'ms' }}>{word}&nbsp;</span>
                        })}</p></div>
