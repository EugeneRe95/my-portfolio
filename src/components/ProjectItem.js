...
export class ProjectItem extends Component {
    ...
    render() {
        return (
            <div className={"portfolio-item animated fadeInUpBig"} key={this.props.key} style={{ background: `url(${this.props.path}) no-repeat center top /cover`, animationDelay: this.props.animDelay+'ms'}} onMouseOver={this.hoverBlock} onMouseOut={this.hoverBlock}>
